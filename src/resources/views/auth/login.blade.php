<x-guest-layout>
    <div class="flex items-center justify-center bg-yellow-50 overflow-hidden">
        <!-- 背景画像（切れないように表示） -->
        <img src="https://4.bp.blogspot.com/-uY6ko43-ABE/VD3RiIglszI/AAAAAAAAoEA/kI39usefO44/s800/fruit_ringo.png" 
            alt="中央画像" 
            class="absolute top-0 left-0 w-full h-full object-contain opacity-70">
        ...
        <div class="z-10 p-8 rounded-lg  max-w-md w-full">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="block mt-4">
                    <label for="remember_me" class="inline-flex items-center">
                        <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="remember">
                        <span class="ms-2 text-sm text-gray-600">{{ __('Are you RUNTEQ?') }}</span>
                    </label>
                </div>
