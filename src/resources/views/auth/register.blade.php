<x-guest-layout>
    ...
    <div class="z-10 p-8 rounded-lg  max-w-md w-full mt-4">
        ...
        <div class="flex items-center justify-end mt-0">
            <a class="underline text-sm text-yellow-50 hover:text-green-300 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" href="{{ route('login') }}">
